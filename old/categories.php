...
$cat_name=mysqli_fetch_assoc(mysqli_query($con, "select categories from categories where id=$cat"));
$product=get_product($con,'',$cat);
?>
<br>
<br>
<br>
...
<div class="container-fluid">
	<div class="titles">Category - <?php echo $cat_name['categories']; ?><br><br><h5> Showing <?php echo count($product);?> Product(s)</h5></div>
</div>
